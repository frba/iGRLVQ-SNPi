...
public:
    ...
    bool getNextRow(MatVector<float> &row, std::map<int, int> &groupLabels, int &group) {
    ...
    static bool readArffBD(const std::string filename, MatMatrix<float> &data, std::map<int, int> &groupLabels, std::vector<int> &groups) {
        ...
        static bool readArffBD(const std::string filename, MatMatrix<float> &data, std::map<int, int> &groupLabels, std::vector<int> &groups, int classIndex) {
        std::ifstream file(filename.c_str());
    ...
    static void rescaleCols01(MatMatrix<float> &data, int min, int max) {
